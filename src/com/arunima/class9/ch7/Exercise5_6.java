	...
	public static void main(String[] args) 
	{
		...
		else 
		{
			...
			if ( Math.sqrt(a)==Math.floor(Math.sqrt(a)) )
			{
				...
				{
					System.out.println( "Both " + a + " and " + b + "are perfect squares." ) ;
				}
			}
			else if (Math.sqrt(b)==Math.floor(Math.sqrt(b)))
			{
			...
			{
				System.out.println( "Neither of the numbers are perfect squares." ) ;
			}
